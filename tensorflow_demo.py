...
def run_visualization(model, input_image_filename):
    """ Inferences DeepLab model and visualizes result. """
    print('running deeplab on image %s...' % input_image_filename)
    resized_im, seg_map = model.run(Image.open(input_image_filename))
    # vis_segmentation(resized_im, seg_map)


if __name__ == "__main__":
    model = load_model()
    run_visualization(model, "test2/image-0000001.jpg")
    run_visualization(model, "test2/image-0000090.jpg")
    run_visualization(model, "test2/image-0000320.jpg")
